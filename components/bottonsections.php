<section class="botton-section01">
    <div class="banner-botton">
        ...
        <a href="https://app.rdstation.com.br/signup" target="blank"><img src="/img/g253.png"></a>
    </div>
</section>
...
<section class="botton-section03">
    ...
    <div class="info-direita">
        <a class="btn-azul" href="https://app.rdstation.com.br/signup" target="blank"><img src="/img/criar-conta-gratuita-azul.svg"></a>
        <div class="logos">
            <?php
