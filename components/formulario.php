<form action="/enviar.php" method="post" class="form-cadastro">
    ...
    <div class="input-text">
        ...
        <input type="number" name="telefone" placeholder="Insira seu número de telefone">
    </div>
    <div class="input-text">
        <label for="ocupacao">Seu cargo de ocupação</label>
        <input type="text" name="cargo" placeholder="Selecione seu cargo">
    </div>
    <div class="input-text">
    ...
    <div class="input-text">
        ...
        <input type="password" name="senha" placeholder="Branding-rd@2021*">
    </div>
